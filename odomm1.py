...
class Model:
	...
	def run(self):
		if(self.btn1==1 and self.a==0):
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(0.9322030124,-0.0189742847)
				self.tr=0
			self.a=6 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(1.123328953,-0.01982823987)
				self.tr=0
			self.a=7 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(1.299814986,-0.02940432525)
				self.tr=0
			self.a=8 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(1.468748921,-0.0042235612)
				self.tr=0
			self.a=9
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(1.638694980,-0.0164416523)
				self.tr=0
			self.a=10 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(1.8358373346,-0.024423409)
				self.tr=0
			self.a=11 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(2.004254782,-0.023998455)
				self.tr=0
			self.a=12 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(2.100987746,-0.019948245)
				self.tr=0
			self.a=13 					
