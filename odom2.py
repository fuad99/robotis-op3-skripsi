...
class Model:
	...
	def run(self):
		if(self.btn1==1 and self.a==0):
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(0.247415304184,0.0066732101142)
				self.tr=0
			self.a=2
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(0.41639287812,0.0019144599008)
				self.tr=0
			self.a=3 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(0.594694694592,-0.0122434543)
				self.tr=0
			self.a=4 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(0.76856513324,-0.0144244214)
				self.tr=0
			self.a=5 
		elif(self.a==5 and self.cntjln==5):
			time.sleep(5)
			if(self.x>=0.76):
				self.jalan(self.walk2,6)	
				if(self.tr==1):
					time.sleep(4.9)
					self.odom_pub(0.7536413324,-0.0389742847)
					self.tr=0
				self.a=6 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(0.9098630124,-0.02497468947)
				self.tr=0
			self.a=7 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(1.023328953,-0.01982823987)
				self.tr=0
			self.a=8 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(1.249814986,-0.02940432525)
				self.tr=0
			self.a=9 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(1.438748921,-0.0042235612)
				self.tr=0
			self.a=10
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(1.598694980,-0.0164416523)
				self.tr=0
			self.a=11 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(1.7558373346,-0.024423409)
				self.tr=0
			self.a=12 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(1.944254782,-0.023998455)
				self.tr=0
			self.a=13 
			...
			if(self.tr==1):
				time.sleep(4.9)
				self.odom_pub(2.060987746,-0.019948245)
				self.tr=0
			self.a=14 					
