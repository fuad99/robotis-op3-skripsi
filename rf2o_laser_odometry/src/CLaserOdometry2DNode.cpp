...
public:
  ...
  ros::Subscriber laser_sub, initPose_sub,sub;
  ...
  CLaserOdometry2D()
{
  ...
  pn.param<std::string>("base_frame_id", base_frame_id, "/laser_link");
  ...
  sub = n.subscribe<std_msgs::Int32>("cmd",1,&CLaserOdometry2DNode::chatterCallback,this);
...
void CLaserOdometry2DNode::process(const ros::TimerEvent&)
{
  ...
  if( is_initialized() && scan_available() && a==1)
  {
...
//                                   CALLBACKS
//-----------------------------------------------------------------------------------
void CLaserOdometry2DNode::chatterCallback(const std_msgs::Int32::ConstPtr& msg)
{
  if(msg->data==1){
    a=1;
  }
